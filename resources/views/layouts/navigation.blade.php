    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:block">
                <div class="flex items-center">
                    <a href="#" class="px-3 py-2 text-sm font-medium text-gray-700 hover:text-indigo-600">Sign
                        In</a>
                    <a href="#" class="ml-4 px-5 py-2 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700 transition duration-150">Sign
                        Up</a>
                </div>
            </div>
            <div class="md:hidden">
