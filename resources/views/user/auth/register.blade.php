            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="py-6 px-8">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <button
                            class="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md hover:bg-gray-50 transition duration-150">
                    ...
                    <div class="text-center mt-6">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="{{ route('login') }}" class="font-medium text-indigo-600 hover:text-indigo-500">Sign
                                in</a>
                        </p>
                    </div>
                </div>
